    ...
    <div className="container mx-auto px-2 md:px-0">
      ...
      <div className="grid grid-cols-12 gap-5">
          ...
          <div className="grid grid-cols-2 gap-5 max-h-[80vh] overflow-scroll custom-scrollbar md:pr-5">
            ...
            {tabValue === "Color Palettes" &&
              themeColorPalette.themeOne.map((palette, index) => (
                <div
                  key={`palette_${index}`}
                  className={`cursor-pointer flex gap-1 p-2 rounded border ${
                    selectedColorPalette.index === index ? "border-blue-500" : "border-transparent"
                  }`}
                  onClick={() =>
        ...
        <div className="col-span-12 md:col-span-7 bg-white mt-3" ref={resumeRef}>
          {/* Render live preview here if needed */}
